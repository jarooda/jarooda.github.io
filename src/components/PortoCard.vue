<template>
  <div class="flex flex-wrap justify-center border-t-2 border-gray-500 hover:border-dark-green dark:hover:border-blue-400 rounded-md sm:mx-0 transition duration-300 ease-in-out transform sm:hover:-translate-y-3 sm:hover:translate-x-1 dark:bg-gray-800 bg-gray-100 shadow-md w-full">
