...
Jadi sebelumnya aku sudah me-revamp website ini dari yang awalnya [Vue.js menjadi Astro](https://www.jaluwibowo.id/blog/hello-world-revamp-dan-astro/). Saat itu versi astro yang ku gunakan masih versi `3.0.10`, kemudian pada [Mei 2024](https://github.com/jarooda/jarooda.github.io/commit/46686550e6a0c2c28f0965aeced5584994282368#diff-7ae45ad102eab3b6d7e7896acd08c427a9b25b346470d7bc6507b6481575d519L27), aku menaikkan versinya menjadi `4.7.1` karena tidak terlalu banyak perubahan yang bersifat *breaking changes*.

Satu tahun menggunakan [Astro](https://www.jaluwibowo.id/tags/astro/) sangat mengasyikan, untuk konten blog, aku hanya perlu membuat sebuah file `mdx`, sedangkan untuk fitur, penggunaan *vanilla* Javascript pun cukup untuk web ini. Web ini tidak memerlukan manajemen state yang kompleks hingga membutuhkan *library* atau *framework* lain seperti [React](https://www.jaluwibowo.id/tags/react/) maupun [Vue](https://www.jaluwibowo.id/tags/vue/).
